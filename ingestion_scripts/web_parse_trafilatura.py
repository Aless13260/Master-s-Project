...
Reads:  ingestion_json/pointers.json  (JSONL of pointer events)
Writes: ingestion_json/contents.jsonl (JSONL of extracted contents)

Notes:
- Skips links that point to PDFs (by extension or content-type header).
                ...
                if exhibit_url:
                    ...
                    if exhibit_resp:
                        ...
                        if "pdf" not in exhibit_resp.headers.get("Content-Type", "").lower():
                            ...
                            # Exhibit itself is a PDF - skip it
